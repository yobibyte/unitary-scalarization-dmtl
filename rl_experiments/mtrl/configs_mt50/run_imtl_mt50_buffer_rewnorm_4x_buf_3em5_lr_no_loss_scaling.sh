...
agent.optimizers.actor.lr=3e-5 \
agent.optimizers.critic.lr=3e-5 \
agent.optimizers.alpha.lr=3e-5 \
...
setup.seed=$1 \
+label=imtl_mt50_buffer_rewnorm_4x_buf_3e5mlr_naive_alpha_no_loss_scaling

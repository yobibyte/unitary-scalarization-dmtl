...
+agent.multitask.buffer_reward_normalisation=False \
+agent.multitask.environment_reward_normalisation=True \
setup.seed=$1 \
+label=pcgrad_buffer_old_rewnorm_4x_buf_share_alpha
